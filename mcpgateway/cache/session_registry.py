...
class SessionRegistry(SessionBackend):
    ...
    async def respond(
        ...
        if self._backend == "none":
            ...
            def _db_read_session(session_id) -> Any:
            ...
            def _db_remove(session_id, message) -> None:
            ...
            async def message_check_loop(session_id) -> None:
            ...
            try:
                ...
                for session_id, transport in local_transports.items():
                    try:
                        ...
                        def _refresh_session(session_id=session_id) -> bool:
